...
export default function DatasetListPage() {
  ...
  if (loading)
    return <div className="flex items-center justify-center min-h-[50vh]"><Loader2 size={32} className="animate-spin text-teal-600 dark:text-teal-400" /></div>;
    ...
    <div>
      ...
      {datasets.length === 0 ? (
        ...
        <div className="space-y-3">
          {datasets.map((ds, i) => (
            <motion.div key={ds.id} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}
